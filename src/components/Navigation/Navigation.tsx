      ...
      <AnimatePresence>
        {open ? (
          <motion.div
            ...
            className="from-[#171028]/98 to-[#0d0a18]/98 mt-3 origin-top rounded-2xl border border-white/10 bg-gradient-to-b p-3 shadow-[0_25px_60px_rgba(0,0,0,0.55)] backdrop-blur-xl lg:hidden"
            role="menu"
